 ...
 * https://modernizr.com/download/?-cssanimations-csstransforms3d-csstransitions-touchevents-domprefixes-prefixed-prefixes-setclasses-shiv-testallprops-testprop-teststyles !*/
! function (e, t, n) {
    function r(e, t) {
        return typeof e === t
    }
    ...
    function h(e, t, o, i) {
        ...
        for (var c, d, p, h, v, g = ["modernizr", "tspan", "samp"]; !F.style && g.length;) c = !0, F.modElem = s(g.shift()), F.style = F.modElem.style;
        for (p = e.length, d = 0; p > d; d++)
            if (h = e[d], v = F.style[h], a(h, "-") && (h = l(h)), F.style[h] !== n) {
                if (i || r(o, "undefined")) return u(), "pfx" == t ? h : !0;
                try {
                    F.style[h] = o
                } catch (y) {}
                if (F.style[h] != v) return u(), "pfx" == t ? h : !0
            } return u(), !1
    }
    ...
    function v(e, t, n, o, i) {
        ...
        return r(t, "string") || r(t, "undefined") ? h(s, t, o, i) : (s = (e + " " + _.join(a + " ") + a).split(" "), d(s, t, n))
    }
    ...
    var w = "Moz O ms Webkit",
        _ = S._config.usePrefixes ? w.toLowerCase().split(" ") : [];
    S._domPrefixes = _;
    var T = "CSS" in e && "supports" in e.CSS,
        N = "supportsCSS" in e;
    Modernizr.addTest("supports", T || N);
    var z = S._config.usePrefixes ? w.split(" ") : [];
    S._cssomPrefixes = z;
    ...
    S.testAllProps = v, S.testAllProps = g, Modernizr.addTest("csstransforms3d", function () {
        ...
        return e
    }), Modernizr.addTest("csstransitions", g("transition", "all", !0)), Modernizr.addTest("cssanimations", g("animationName", "a", !0));
    S.prefixed = function (e, t, n) {
        return 0 === e.indexOf("@") ? k(e) : (-1 != e.indexOf("-") && (e = l(e)), t ? v(e, t, n) : v(e, "pfx"))
    };
